...
@include('layoutsV.header')

<!--Morris Chart CSS -->
<link rel="stylesheet" href="{{ asset('/plugins/morris/morris.css') }}">
@include('layoutsV.headerStyle')

<body class="fixed-left">
<!-- @ include('layoutsV.loader')-->


<!-- Begin page -->
<div id="wrapper">
@include('layoutsV.navbar')
                    ...
                    <ul class="list-inline float-right mb-0">
                        ...
                        <li class="list-inline-item dropdown notification-list hidden-xs-down">
                            ...
                            <div class="dropdown-menu dropdown-menu-right language-switch">
                                <a class="dropdown-item" href="#"><img src="public/{{ asset('assets/images/flags/germany_flag.jpg') }}" alt="" height="16"/><span> German </span></a>
                        ...
                        <li class="list-inline-item dropdown notification-list">
                            ...
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                <a class="dropdown-item" href="#"><i class="dripicons-user text-muted"></i> {{ ucwords(Auth::user()->name) }}</a>
...
<!-- Page specific js -->
<script src="{{ asset('/assets/pages/dashborad-2.js') }}"></script>
